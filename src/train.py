...
if __name__ == "__main__":
    ...
    for epoch in tqdm(range(NUM_EPOCHS), ):
        ...
        print(f"Epoch {epoch+1:3d}, Train Loss: {training_loss:.4f}, Val Loss: {validation_loss:.4f}, Val Dice: {epoch_dice_score:.4f}")
        ...
        if epoch_dice_score > best_validation_dice_score:
            ...
            if epochs_without_improvement >= PATIENCE:
                print(f"Early stopping at epoch {epoch+1}. Best validation dice score: {best_validation_dice_score:.4f}")
                break